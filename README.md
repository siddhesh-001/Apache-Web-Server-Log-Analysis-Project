...
**Objectives**: Deploy an Apache web server, Generate suspicious web traffic, Collect Apache access logs remotely, Perform command-line log analysis, Document findings as a security case report
